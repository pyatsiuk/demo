...
with sync_playwright() as p:
    ...
    def fill_date_time(datepicker, date_str, hours, minutes):
        ...
        date_input.press_sequentially(date_str, delay=300)
        date_input.press("Tab")
        
        page.wait_for_timeout(1000)  # збільшили з 800 до 1500
        
        time_input.click()
        page.wait_for_timeout(300)   # додали паузу після кліку
    ...
    option2.locator("awr-datepicker").nth(2).click()
    option2.locator("label").filter(has_text="Departure Block Date").nth(1).click()
    ...
    option2.locator("awr-datepicker").nth(5).click()
    page.pause()
    page.get_by_text("Block Time").nth(5).click()
    page.get_by_text("Arrival Block Date").nth(5).click()
    # option2.locator("awr-datepicker").nth(2).click()
    # option2.locator("label").filter(has_text="Departure Block Date").nth(1).click()
    option2.locator("awr-datepicker").nth(2).click()
    # option2.locator("awr-datepicker").nth(5).click()
    # option2.locator("awr-datepicker").nth(4).click()
